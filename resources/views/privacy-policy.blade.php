    ...
    <section class="py-[50px]">
        <div class="container m-auto flex px-4" style="max-width: 750px;">
            <div class="w-full px-4 policy">
                <h1>Privacy Policy for GiftForPakistan</h1>
                <p>At GiftForPakistan, accessible from https://giftforpakistan.com, one of our main priorities is the
                    privacy of our visitors. This Privacy Policy document contains types of information that is collected
                    and recorded by GiftForPakistan and how we use it.</p>
                ...
                <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
                    regards to the information that they shared and/or collect in GiftForPakistan. This policy is not
                ...
                <h2>Log Files</h2>
                <p>GiftForPakistan follows a standard procedure of using log files. These files log visitors when they visit
                ...
                <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
                    used in their respective advertisements and links that appear on GiftForPakistan, which are sent
                ...
                <p>Note that GiftForPakistan has no access to or control over these cookies that are used by third-party
                    advertisers.</p>
                <h2>Third Party Privacy Policies</h2>
                <p>GiftForPakistan's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
                ...
                <p>GiftForPakistan does not knowingly collect any Personal Identifiable Information from children under the
